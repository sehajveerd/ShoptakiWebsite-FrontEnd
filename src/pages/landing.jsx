...
const Landing = () => {
  ...
  return (
    <div className="relative bg-white w-full overflow-hidden flex flex-col items-center justify-start gap-[191px] text-left text-17xl text-dimgray-401 font-poppins">
