...
const NavigationSidebar = () => {
  ...
  return (
    <div className="absolute top-0 left-[0px] rounded-t-none rounded-br-xl rounded-bl-none bg-white shadow-[0px_4px_10px_rgba(0,_0,_0,_0.15)] w-60 h-[695px] overflow-hidden text-left text-sm text-neutralgray-600 font-body-xs12">
